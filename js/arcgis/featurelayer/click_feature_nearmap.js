...
require([
 ...
 // . . . nearmap only . . .
              ...
              console.log('before create tile layer, nearmap_opacity', nearmap_opacity)
                                          ...
                                          $('#point_radius_range').on('change', function() {
                                            ...
                                            symbol_changed()
                                                  ...
                                                  symbol_color.on('color:change', function(color) {
                                                                                                              // log the current color as a HEX alpha string  https://iro.js.org/color_api.html#varructor
