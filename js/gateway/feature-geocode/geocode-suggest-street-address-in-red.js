...
/**/
      ...
      async function suggest(){
            ...
            if (keywords){
              ...
              // real poi (no color) 
              await basic_default_suggest_this_category_paint_as_this_color("POI", "no-color")
              // real address (no color) 
              await basic_default_suggest_this_category_paint_as_this_color("Point Address", "no-color")
              
              /**/
              //  -  -  - fake street address in red  -  -  - 
              /**/
              await basic_default_suggest_this_category_paint_as_this_color("Street Address", "red")
              /**/
              //  -  -  - end  -  -  -  fake street address in red    -  -  - 
              /**/
              ...
              /**/
                ...
                if ((Number.isInteger(Number(keywords))) && (keywords.length > 1)){
                  ...
                  await advanced_number_search_this_category_paint_as_this_color("Point Address", "no-color")

                  /**/
                  //  -  -  - fake street address in red  -  -  - 
                  /**/
                   await advanced_number_search_this_category_paint_as_this_color("Street Address", "red")
                  /**/
                  //  -  -  - end  -  -  -  fake street address in red    -  -  - 
                  /**/
      ...
      function init_geocode(){
        ...
        show_locator_category() // must use
