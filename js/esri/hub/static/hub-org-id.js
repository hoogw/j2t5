      ...
      for (let x = 0; x < 9; x++) {
        ...
        if (response){
              if (response.currentVersion){
                ...
                message_html = '<span style="font-size:30px;  background-color:#FFA500;">' + (i+1) + '</span> - <span>' + _source + '</span> - <span>' + testURL
                $("#message-span").html(message_html)
              
                break; // for loop

              } else {
                message_html = '<span style="font-size:30px; ">' + (i+1) + '</span> - <span>' + _source + '</span> - <span>' + testURL
                $("#message-span").html(message_html)
              }//if
        }//if
...
/**/
  ...
  function remove_duplicate_orgid(_raw_inputCurrent){
    ...
    for (var i = 0; i < _raw_inputCurrent.length; ++i){ 
      ...
      var hub_orgId = _raw_inputCurrent[i].properties.orgId;
      if (hub_orgId){
