           ...
           // listen for event https://www.jstree.com/api/#/?q=.jstree%20Event
            ...
            //.on('activate_node.jstree', function (e, data) {
                                        ...
                                        for(i = 0, j = data.selected.length; i < j; i++) {
                                          ...
                                          console.log('multi_selected_featureLayerObject_on_map', layerid_as_key,  multi_selected_featureLayerObject_on_map)
                                                ...
                                                switch(layertype_) {
                                                          ...
                                                          case "layer":
                                                            ...
                                                            console.log(' render "layer" ', layerid_as_key, layername___)
                                                                ...
                                                                // create feature layer is very slow, at this point maybe not complete create yet, will not be ready yet.
                                                                // I must put a place holder here 
                                                                multi_selected_featureLayerObject_on_map[layerid_as_key] = {"place_holder": "for selected node" }
