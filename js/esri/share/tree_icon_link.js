...
/*
 ...
 2. replace 'window.open(_newTab_link,'_blank');
...
break;
  ...
  case "embed_7510":
    var _newTab_link =  url_for_microsoft.replace('microsoft/basemap.html?', 'microsoft-poi/pan-zoom.html?') + '&layer_id=' + _selected_layer_id[0] +  '&url=' + _selected_server_path[0]   
    window.open(_newTab_link,'_blank');
    console.log('_newTab_link', _newTab_link)
  break;
  ...
  case "embed_8522":
    var _newTab_link =  url_for_microsoft.replace('microsoft/basemap.html?', 'microsoft-poi/pan-zoom-googlebasemap.html?') + '&layer_id=' + _selected_layer_id[0] +  '&url=' + _selected_server_path[0]   
    window.open(_newTab_link,'_blank');
    console.log('_newTab_link', _newTab_link)
  break;
