...
require([
  ...
  "esri/Graphic",
          ...
          */
          ...
          var county_layer_url = ___url_string + '/12' 


          // level 1 is state name
          var level1_field_name = 'STATE_NM'
          var level1_url = county_layer_url + '/query?outFields='
          ...
          // level 2 is county
          var level2_field_name = 'COUNTY_NM'
          var county_fips_cd_field_name = 'CMN_STATE_COUNTY_FIPS_CD'
          var county_fips_cd = {}
          var level2_url = county_layer_url + '/query?outFields=' + county_fips_cd_field_name + ','
...
/**/
  ...
  /* .... ... ... external function ... ... ... */     
              ...
              async function work_on_value(workonthiskeyword, index){
                ...
                countyMapImageLayer = new MapImageLayer({
                                                      ...
                                                      sublayers: [{
                                                          ...
                                                          //definitionExpression: county_fips_cd_field_name +'=\'' + county_fips_cd[workonthiskeyword] + '\'' ,
                ...
                */
                ...
                //Zoom to county
                countyFeatureLayer = new FeatureLayer({
                ...
                const countyQuery = {
                                      ...
                                      // fips id works, do not have to use, in this case, not use 
                                      //where: county_fips_cd_field_name + '=\'' + county_fips_cd[workonthiskeyword] + '\'',
                ...
                countyFeatureLayer.queryFeatures(countyQuery)
                ...
                countyFeatureLayer.queryExtent(countyQuery).then(function (results) {
              ...
              // only for county layer (popup template) 
              function displayResults(results) {
                ...
                view.goTo(results.features);
                      ...
                      const popupTemplate = {
                        ...
                        content: "{CMN_STATE_NM} &nbsp; {CMN_STATE_ABBR} <br> FIPS: {CMN_STATE_COUNTY_FIPS_CD}"
                      };
                      ...
                      results.features.map((feature) => {
                        ...
                        // feature here is actually a graphic object https://developers.arcgis.com/javascript/latest/api-reference/esri-Graphic.html#properties-summary
              ...
              async function build_level2_list(filterbykeyword, index){
                ...
                update_url_parameter('select_level2value', -1);
                    ...
                    for (let j = 0; j < raw_distinct_level2_value.features.length; j++) {
                      ...
                      county_fips_cd[_level_2_value] = raw_distinct_level2_value.features[j]['attributes'][county_fips_cd_field_name]
                    }
