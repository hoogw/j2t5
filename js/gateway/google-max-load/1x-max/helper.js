...
if (_supportsPagination){
    ...
    // resultRecordCount can not greater than maxRecordCount,
    //  use tile, standard 
    // _url_returngeojson += '&resultRecordCount=' + limit

    // if you want over maxRecordCount, use tile, standard instead below
    if (_supportsQueryWithResultType){
      // search resultType https://developers.arcgis.com/rest/services-reference/enterprise/feature-layer/#GUID-4A5823ED-2ED9-4268-8E86-FCF7B6EE022B
      //_url_returngeojson += '&resultType=' + 'standard' // standardMaxRecordCount,  is always used for point and table layers.
      //_url_returngeojson += '&resultType=' + 'tile'       // tileMaxRecordCount,      is always used for point layers.

      // none ,  resultRecordCount=xxx, means less than maxRecordCount
      //_url_returngeojson += '&resultType=' + 'none'     // maxRecordCount used, 1000 or 2000
    }

     switch (limit_radio_value) {
        case "1x-tile-max":
          _url_returngeojson += '&maxRecordCountFactor=' + '1'
          _url_returngeojson += '&resultType=' + 'tile'
          break;
        case "2x-tile-max":
          _url_returngeojson += '&maxRecordCountFactor=' + '2'
          _url_returngeojson += '&resultType=' + 'tile'
          break;
        case "4x-tile-max":
          _url_returngeojson += '&maxRecordCountFactor=' + '4'
          _url_returngeojson += '&resultType=' + 'tile'
          break;
        case "8x-tile-max":
          _url_returngeojson += '&maxRecordCountFactor=' + '8'
          _url_returngeojson += '&resultType=' + 'tile'
          break;
        ...
        case "1x-standard-max":
          _url_returngeojson += '&maxRecordCountFactor=' + '1'
          _url_returngeojson += '&resultType=' + 'standard'
          break;
