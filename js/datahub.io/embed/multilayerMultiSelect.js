...
/**/
        ...
        // -- - - - only for hover multiple layer-- - - -   mouse-move -- - - - event -- - - - only for hover multiple layer -- - - -
          ...
          /**/
          //  -- -- -- select multiple layer only -- -- -- label and color  -- -- -- 
          ...
          $("input[type='radio'][name='polygonFillBy_radio']").change(function(){
            ...
            //  -- -- -- select multiple layer only -- -- -- label and color  -- -- -- 
            for (const [key, value] of Object.entries(multi_selected_featureLayerObject_on_map)) {
              console.log('enforce yellow and custom fill on all feature layer on map : ', `${key}: ${value}`);
              enforce_yellow_linepointpolygon(multi_selected_featureLayerObject_on_map[key]);
            }//for
