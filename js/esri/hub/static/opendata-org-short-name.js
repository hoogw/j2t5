...
// test sample:  http://localhost:10/json2tree/esri/hub/static/hub-org-short-name.html?file=hub_v1_created_2025_3_26.zip&filter_by=
      ...
      if (run_ajax_status){
        ...
        if (ajaxedResult_orgshortname_askey.hasOwnProperty(org_short_name)){
              ...
              console.log('skip index already done ', i, )
                    ...
                    google_api_url = google_api_url_template + '&q=' + org_short_name + ' ' + hub_orgName + ' rest services folder layer'
                    //google_api_url = google_api_url_template + '&q=' + org_short_name + ' ' + hub_orgName + " '/rest/services' folder layer"
                    ...
                    message_html = '<span style="font-size:30px;  background-color:#FFA500;">' + (i+1) + '</span> - <span>' + hub_orgName + '</span> - <span>' + google_api_url
                         ...
                         for (let g = 0; g < google_items.length; g++) {
                          ...
                          if (google_link.includes('/rest/services/')){
                            ...
                            if (possible_selfHosted_rest_array.includes(_rest_service_root)){
                              ...
                              message_html = '<span style="font-size:30px;  background-color:#FFA500;">' + (i+1) + '</span> - <span>' + hub_orgName + '</span> - <span>' + _rest_service_root
                              $("#message-span").html(message_html)
...
/**/
    ...
    function remove_duplicate_orgshortname(_raw_inputCurrent){
      ...
      for (var i = 0; i < _raw_inputCurrent.length; ++i){ 
        ...
        var ___siteUrl = _raw_inputCurrent[i].attributes.url;   // true site url 
