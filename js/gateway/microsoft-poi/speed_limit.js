...
/**/
    ...
    function get_microsoft_speed_limit(_centerLng, _centerLat) {
        ...
        // api https://learn.microsoft.com/en-us/javascript/api/azure-maps-rest/atlas.service.searchurl?view=azure-maps-typescript-latest#azure-maps-rest-atlas-service-searchurl-searchaddressreverse
         searchURL.searchAddressReverse(
            ...
            // search Address Reverse Options  api https://learn.microsoft.com/en-us/rest/api/maps/search/get-search-address-reverse?view=rest-maps-1.0&tabs=HTTP
            {
            ...
            console.log('search search Address Reverse result ', results)

            var speedLimit = results.addresses[0].address.speedLimit
            
            var freeformAddress = results.addresses[0].address.freeformAddress
            
            var position_string = results.addresses[0].position
            var position_array = position_string.split(",");
            var position_array_number = [Number(position_array[1]), Number(position_array[0])]

            var roadUse_array = results.addresses[0].roadUse
            var roadUse = roadUse_array.toString()

            console.log('freeformAddress ', freeformAddress)
            console.log('speedLimit ', speedLimit)
            console.log('position_array_number ', position_array_number)


            var marker = new atlas.HtmlMarker({
                color: 'DodgerBlue',
                htmlContent: '<span style="font-size:16.3px; color:white; background-color:red;">&nbsp;' + speedLimit + '&nbsp;</span>',
               
                position: position_array_number,
        ...
        function add_map_event(){
            ...
            map.events.add('moveend', function(){
                ...
                map.events.add('click', function(event){
                    ...
                    get_microsoft_speed_limit(event.position[0],  event.position[1])
