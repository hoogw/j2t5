          ...
          // ----------  add map listener idle ---------- 
                              ...
                              function add_map_listener_idle(){   
                                ...
                                listener_idle =  map.addListener('idle', function() {   
                                  ...
                                  //  --- google manual drawing square   --- 
                                  /**/
                                  get_square_edge_in_map_bound()
                                  manually_adjust_max_square_edge()
...
document.getElementById("file-input").addEventListener("change", (event) => {
  ...
  //  - -- - if you want to add multiple geojson, then don't remove previous geojson by comment out this section  - -- - 
       ...
       if (_added_geojson_reference_layer){     
        for (var l = 0, len = _added_geojson_reference_layer.length; l < len; l++){
                    map.data.remove(_added_geojson_reference_layer[l]);
        }// for
       }// if
...
/**/
  ...
  $("#square_edge_range").on("change", function() {
    current_square_edge = Number($(this).val());
