...
var single_selected_featureLayer_url
...
/**/
                          ...
                          //.on('select_node.jstree', function (e, data) {
                              ...
                              switch(layertype_) {
                                  ...
                                  case "layer":
                                        ...
                                        single_selected_featureLayer_url = ___url_string + '/' + layerid_as_key

                                        update_layer_name(single_selected_featureLayer_url, layername___)    
                                        ...
                                        sublayer.createFeatureLayer()
                                                                                    ...
                                                                                    .then((featureLayer) => {
                                                                                        ...
                                                                                        view.whenLayerView(single_selected_featureLayerObject_on_map).then(function(layerView){
                                                                                          ...
                                                                                          enforce_yellow_linepointpolygon(single_selected_featureLayerObject_on_map)
 ...
 // -- - - - -- - - -   mouse-move -- - - - event -- - - -  
  ...
  /* */
        ...
        // only for :  multiple layer, single select,   click or hover     
