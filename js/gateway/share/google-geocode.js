        ...
        if (findAddressCandidatesGeocode_json.error){
          ...
          if (_candidates_array.length){
             ...
             $('#info-window-div').html(_candidates_html)
              ...
              map.setCenter(new google.maps.LatLng(candidate_lat, candidate_lng))
              // do not zoom to by comment out this line
              map.setZoom(Number($("#zoom2level-input").val())) // default 20


              // .............. street view is always on .............. 
                  // update exsiting street view
                  turn_on_street_view(candidate_lat, candidate_lng, 100)
