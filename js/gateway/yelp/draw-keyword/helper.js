...
/**/
        ...
        var current_circle_radius
          ...
          function setLimit_onNearbyCircleRadius(){
            ...
            if (_center_radius_in_meter > max_yelp_poi_radius_meter){
                _center_radius_in_meter = max_yelp_poi_radius_meter
            }
            console.log('yelp nearby limit 40k _center_radius_in_meter',  _center_radius_in_meter)
            //only for single auto version
            $('#radius_div').html('<span style="font-size:12.7px">Circle Radius: ' + _center_radius_in_meter + '  meters (yelp limit max 40000 meters(about 25 miles) </span>');
    ...
    current_circle_radius = Math.floor(_center_radius_in_meter / 4);
          ...
          // only for yelp manual drawing circle
