...
/**/
  ...
  $("#loading-feature").html(_geojson_object.features.length)          
...
//  - - -  max load     - - - 
/**/
   var start_query_count_time = performance.now();
/**/
//  --- end  ---  max load   - - - 
/**/
                ...
                try{
                    ...
                    // jsonp
                      $.ajax({
                                                    ...
                                                    //  - - -  max load     - - - 
                                                    /**/
                                                      var end_query_count_time = performance.now();
                                                      var time_used_count = (end_query_count_time - start_query_count_time) /1000
                                                      $("#time-used-query-count").html(time_used_count.toFixed(3))
...
//  - - -  max load     - - - 
/**/
   var start_query_data_time = performance.now();
/**/
//  --- end  ---  max load   - - - 
/**/
                                              ...
                                              beforeSend:  function( jqXHR, settings ){
                                                ...
                                                error: function (jqXHR, textStatus, errorThrown) {
                                                  ...
                                                  success: function (data) {
                                                    ...
                                                    //  - - -  max load     - - - 
                                                    /**/
                                                      var end_query_data_time = performance.now();
                                                      var time_used_data = (end_query_data_time - start_query_data_time) /1000
                                                      $("#time-used-query-data").html(time_used_data.toFixed(3))
