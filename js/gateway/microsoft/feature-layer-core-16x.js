...
function ajax_GeoJSON() {
    ...
    // does not support 180, 0 meridian
    NW_center_lat  = (NElat + _center_lat) / 2
    NW_center_long = (SWlong + _center_long) / 2
    // does not support 180, 0 meridian
    SE_center_lat  = (SWlat + _center_lat) / 2
    SE_center_long = (NElong + _center_long) / 2




    NW_envelope_1 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SWlong +',         "ymin" : '+ NW_center_lat + ',   "xmax" : '+ NW_center_long +',   "ymax" : '+ NElat + '}')
    NW_envelope_2 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ NW_center_long +', "ymin" : '+ NW_center_lat + ',   "xmax" : '+ _center_long +',     "ymax" : '+ NElat + '}')
    NW_envelope_3 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ NW_center_long +', "ymin" : '+ _center_lat + ',     "xmax" : '+ _center_long +',     "ymax" : '+ NW_center_lat + '}')
    NW_envelope_4 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SWlong +',         "ymin" : '+ _center_lat + ',     "xmax" : '+ NW_center_long +',   "ymax" : '+ NW_center_lat + '}')
    
    NE_envelope_1 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ _center_long +',   "ymin" : '+ NW_center_lat + ',   "xmax" : '+ SE_center_long +',   "ymax" : '+ NElat + '}')
    NE_envelope_2 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SE_center_long +', "ymin" : '+ NW_center_lat + ',   "xmax" : '+ NElong +',           "ymax" : '+ NElat + '}')
    NE_envelope_3 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SE_center_long +', "ymin" : '+ _center_lat + ',     "xmax" : '+ NElong +',           "ymax" : '+ NW_center_lat + '}')
    NE_envelope_4 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ _center_long +',   "ymin" : '+ _center_lat + ',     "xmax" : '+ SE_center_long +',   "ymax" : '+ NW_center_lat + '}')
    
    SE_envelope_1 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ _center_long +',   "ymin" : '+ SE_center_lat + ',   "xmax" : '+ SE_center_long +',   "ymax" : '+ _center_lat + '}')
    SE_envelope_2 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SE_center_long +', "ymin" : '+ SE_center_lat + ',   "xmax" : '+ NElong +',           "ymax" : '+ _center_lat + '}')
    SE_envelope_3 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SE_center_long +', "ymin" : '+ SWlat + ',           "xmax" : '+ NElong +',           "ymax" : '+ SE_center_lat + '}')
    SE_envelope_4 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ _center_long +',   "ymin" : '+ SWlat + ',           "xmax" : '+ SE_center_long +',   "ymax" : '+ SE_center_lat + '}')
    
    SW_envelope_1 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SWlong +',         "ymin" : '+ SE_center_lat + ',   "xmax" : '+ NW_center_long +',   "ymax" : '+ _center_lat + '}')
    SW_envelope_2 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ NW_center_long +', "ymin" : '+ SE_center_lat + ',   "xmax" : '+ _center_long +',     "ymax" : '+ _center_lat + '}')
    SW_envelope_3 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ NW_center_long +', "ymin" : '+ SWlat + ',           "xmax" : '+ _center_long +',     "ymax" : '+ SE_center_lat + '}')
    SW_envelope_4 = encodeURI('{"spatialReference":{"wkid":4326}, "xmin" : '+ SWlong +',         "ymin" : '+ SWlat + ',           "xmax" : '+ NW_center_long +',   "ymax" : '+ SE_center_lat + '}')



      //_url_returngeojson += '&geometry='+ _envelope;
      NW_url_1 = _url_returngeojson + '&geometry=' + NW_envelope_1;
      NW_url_2 = _url_returngeojson + '&geometry=' + NW_envelope_2;
      NW_url_3 = _url_returngeojson + '&geometry=' + NW_envelope_3;
      NW_url_4 = _url_returngeojson + '&geometry=' + NW_envelope_4;

      NE_url_1 = _url_returngeojson + '&geometry=' + NE_envelope_1;
      NE_url_2 = _url_returngeojson + '&geometry=' + NE_envelope_2;
      NE_url_3 = _url_returngeojson + '&geometry=' + NE_envelope_3;
      NE_url_4 = _url_returngeojson + '&geometry=' + NE_envelope_4;

      SE_url_1 = _url_returngeojson + '&geometry=' + SE_envelope_1;
      SE_url_2 = _url_returngeojson + '&geometry=' + SE_envelope_2;
      SE_url_3 = _url_returngeojson + '&geometry=' + SE_envelope_3;
      SE_url_4 = _url_returngeojson + '&geometry=' + SE_envelope_4;

      SW_url_1 = _url_returngeojson + '&geometry=' + SW_envelope_1;
      SW_url_2 = _url_returngeojson + '&geometry=' + SW_envelope_2;
      SW_url_3 = _url_returngeojson + '&geometry=' + SW_envelope_3;
      SW_url_4 = _url_returngeojson + '&geometry=' + SW_envelope_4;

      url_16x.NW_1 = NW_url_1
      url_16x.NW_2 = NW_url_2
      url_16x.NW_3 = NW_url_3
      url_16x.NW_4 = NW_url_4

      url_16x.NE_1 = NE_url_1
      url_16x.NE_2 = NE_url_2
      url_16x.NE_3 = NE_url_3
      url_16x.NE_4 = NE_url_4

      url_16x.SE_1 = SE_url_1
      url_16x.SE_2 = SE_url_2
      url_16x.SE_3 = SE_url_3
      url_16x.SE_4 = SE_url_4

      url_16x.SW_1 = SW_url_1
      url_16x.SW_2 = SW_url_2
      url_16x.SW_3 = SW_url_3
      url_16x.SW_4 = SW_url_4

      //ajax_GeoJSON(_url_returncountonly, _url_returngeojson);
      ajax_GeoJSON_countOnly(_url_returncountonly);
      ajax_GeoJSON_16x(url_16x);
      
    //      - -  -  -   end    - -  -  -  core 16x   - -  -  -

   //  - - - end   - - -  return real data with geometry
...
//       - -  -  -  core 16x   - -  -  -
function ajax_GeoJSON_countOnly(_apiURI_returncountonly) {
  ...
  $.ajax({
                             ...
                             beforeSend:  function( jqXHR_count_only, settings ){
  
                               ___XMLHttpRequest_count_only = jqXHR_count_only
                             },
                           
  
                             url: _apiURI_returncountonly,
                             error: function (jqXHR_count_only, textStatus, errorThrown) {
  ...
  var  ___XMLHttpRequest_NW_1;
  var  ___XMLHttpRequest_NW_2;
  var  ___XMLHttpRequest_NW_3;
  var  ___XMLHttpRequest_NW_4;
  
  var  ___XMLHttpRequest_NE_1;
  var  ___XMLHttpRequest_NE_2;
  var  ___XMLHttpRequest_NE_3;
  var  ___XMLHttpRequest_NE_4;
  
  var  ___XMLHttpRequest_SE_1;
  var  ___XMLHttpRequest_SE_2;
  var  ___XMLHttpRequest_SE_3;
  var  ___XMLHttpRequest_SE_4;
  
  var  ___XMLHttpRequest_SW_1;
  var  ___XMLHttpRequest_SW_2;
  var  ___XMLHttpRequest_SW_3;
  var  ___XMLHttpRequest_SW_4;
  

  
  
function ajax_GeoJSON_16x(_apiURI_16x) {
  //  ***** abort previously  ajax call   ***** 


  // NW-1
  if (___XMLHttpRequest_NW_1){
   if (typeof ___XMLHttpRequest_NW_1.abort !== "undefined"){
     console.log('___XMLHttpRequest_NW_1 - xhr ', ___XMLHttpRequest_NW_1)
     // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
     ___XMLHttpRequest_NW_1.abort() 
     }
   }
   if (___XMLHttpRequest_NW_2){
     if (typeof ___XMLHttpRequest_NW_2.abort !== "undefined"){
       console.log('___XMLHttpRequest_NW_2 - xhr ', ___XMLHttpRequest_NW_2)
       // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
       ___XMLHttpRequest_NW_2.abort() 
       }
   }
   if (___XMLHttpRequest_NW_3){
       if (typeof ___XMLHttpRequest_NW_3.abort !== "undefined"){
         console.log('___XMLHttpRequest_NW_3 - xhr ', ___XMLHttpRequest_NW_3)
         // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
         ___XMLHttpRequest_NW_3.abort() 
         }
   }
   if (___XMLHttpRequest_NW_4){
         if (typeof ___XMLHttpRequest_NW_4.abort !== "undefined"){
           console.log('___XMLHttpRequest_NW_4 - xhr ', ___XMLHttpRequest_NW_4)
           // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
           ___XMLHttpRequest_NW_4.abort() 
           }
   }
  ...
  // NE-1
  if (___XMLHttpRequest_NE_1){
   if (typeof ___XMLHttpRequest_NE_1.abort !== "undefined"){
     console.log('___XMLHttpRequest_NE_1 - xhr ', ___XMLHttpRequest_NE_1)
     // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
     ___XMLHttpRequest_NE_1.abort() 
     }
   }
   if (___XMLHttpRequest_NE_2){
     if (typeof ___XMLHttpRequest_NE_2.abort !== "undefined"){
       console.log('___XMLHttpRequest_NE_2 - xhr ', ___XMLHttpRequest_NE_2)
       // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
       ___XMLHttpRequest_NE_2.abort() 
       }
   }
   if (___XMLHttpRequest_NE_3){
       if (typeof ___XMLHttpRequest_NE_3.abort !== "undefined"){
         console.log('___XMLHttpRequest_NE_3 - xhr ', ___XMLHttpRequest_NE_3)
         // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
         ___XMLHttpRequest_NE_3.abort() 
         }
   }
   if (___XMLHttpRequest_NE_4){
         if (typeof ___XMLHttpRequest_NE_4.abort !== "undefined"){
           console.log('___XMLHttpRequest_NE_4 - xhr ', ___XMLHttpRequest_NE_4)
           // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
           ___XMLHttpRequest_NE_4.abort() 
           }
   }
  ...
  // SE-1
  if (___XMLHttpRequest_SE_1){
   if (typeof ___XMLHttpRequest_SE_1.abort !== "undefined"){
     console.log('___XMLHttpRequest_SE_1 - xhr ', ___XMLHttpRequest_SE_1)
     // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
     ___XMLHttpRequest_SE_1.abort() 
     }
   }
   if (___XMLHttpRequest_SE_2){
     if (typeof ___XMLHttpRequest_SE_2.abort !== "undefined"){
       console.log('___XMLHttpRequest_SE_2 - xhr ', ___XMLHttpRequest_SE_2)
       // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
       ___XMLHttpRequest_SE_2.abort() 
       }
     }
   if (___XMLHttpRequest_SE_3){
       if (typeof ___XMLHttpRequest_SE_3.abort !== "undefined"){
         console.log('___XMLHttpRequest_SE_3 - xhr ', ___XMLHttpRequest_SE_3)
         // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
         ___XMLHttpRequest_SE_3.abort() 
         }
   }
   if (___XMLHttpRequest_SE_4){
         if (typeof ___XMLHttpRequest_SE_4.abort !== "undefined"){
           console.log('___XMLHttpRequest_SE_4 - xhr ', ___XMLHttpRequest_SE_4)
           // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
           ___XMLHttpRequest_SE_4.abort() 
           }
   }
 ...
 // SW-1
  if (___XMLHttpRequest_SW_1){
   if (typeof ___XMLHttpRequest_SW_1.abort !== "undefined"){
     console.log('___XMLHttpRequest_SW_1 - xhr ', ___XMLHttpRequest_SW_1)
     // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
     ___XMLHttpRequest_SW_1.abort() 
     }
   }
   if (___XMLHttpRequest_SW_2){
     if (typeof ___XMLHttpRequest_SW_2.abort !== "undefined"){
       console.log('___XMLHttpRequest_SW_2 - xhr ', ___XMLHttpRequest_SW_2)
       // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
       ___XMLHttpRequest_SW_2.abort() 
       }
     }
   if (___XMLHttpRequest_SW_3){
       if (typeof ___XMLHttpRequest_SW_3.abort !== "undefined"){
         console.log('___XMLHttpRequest_SW_3 - xhr ', ___XMLHttpRequest_SW_3)
         // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
         ___XMLHttpRequest_SW_3.abort() 
         }
   }
   if (___XMLHttpRequest_SW_4){
         if (typeof ___XMLHttpRequest_SW_4.abort !== "undefined"){
           console.log('___XMLHttpRequest_SW_4 - xhr ', ___XMLHttpRequest_SW_4)
           // abort will cause jsonp call back error(normal, no need fix) :  Uncaught ReferenceError jqueryxxxxx_xxxxx  is not defined
           ___XMLHttpRequest_SW_4.abort() 
           }
   }
   ...
   console.log('ajax url-- with-geometry ---> : ', _apiURI_16x);
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NW_1, 

       beforeSend:  function( jqXHR_NW_1, settings ){
                                     ___XMLHttpRequest_NW_1 = jqXHR_NW_1
                    },
       error: function (jqXHR_NW_1, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NW_1  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NW_2, 

       beforeSend:  function( jqXHR_NW_2, settings ){
                                     ___XMLHttpRequest_NW_2 = jqXHR_NW_2
                    },
       error: function (jqXHR_NW_2, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NW_2  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NW_3, 

       beforeSend:  function( jqXHR_NW_3, settings ){
                                     ___XMLHttpRequest_NW_3 = jqXHR_NW_3
                    },
       error: function (jqXHR_NW_3, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NW_3  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NW_4, 

       beforeSend:  function( jqXHR_NW_4, settings ){
                                     ___XMLHttpRequest_NW_4 = jqXHR_NW_4
                    },
       error: function (jqXHR, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NW_4  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NE_1, 

       beforeSend:  function( jqXHR_NE_1, settings ){
                                     ___XMLHttpRequest_NE_1 = jqXHR_NE_1
                    },
       error: function (jqXHR_NE_1, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NE_1  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NE_2, 

       beforeSend:  function( jqXHR_NE_2, settings ){
                                     ___XMLHttpRequest_NE_2 = jqXHR_NE_2
                    },
       error: function (jqXHR_NE_2, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NE_2  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NE_3, 

       beforeSend:  function( jqXHR_NE_3, settings ){
                                     ___XMLHttpRequest_NE_3 = jqXHR_NE_3
                    },
       error: function (jqXHR_NE_3, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NE_3  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.NE_4, 

       beforeSend:  function( jqXHR_NE_4, settings ){
                                     ___XMLHttpRequest_NE_4 = jqXHR_NE_4
                    },
       error: function (jqXHR_NE_4, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_NE_4  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.SE_1, 

       beforeSend:  function( jqXHR_SE_1, settings ){
                                     ___XMLHttpRequest_SE_1 = jqXHR_SE_1
                    },
       error: function (jqXHR_SE_1, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_SE_1  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.SE_2, 

       beforeSend:  function( jqXHR_SE_2, settings ){
                                     ___XMLHttpRequest_SE_2 = jqXHR_SE_2
                    },
       error: function (jqXHR_SE_2, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_SE_2  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.SE_3, 

       beforeSend:  function( jqXHR_SE_3, settings ){
                                     ___XMLHttpRequest_SE_3 = jqXHR_SE_3
                    },
       error: function (jqXHR_SE_3, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_SE_3  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.SE_4, 

       beforeSend:  function( jqXHR_SE_4, settings ){
                                     ___XMLHttpRequest_SE_4 = jqXHR_SE_4
                    },
       error: function (jqXHR_SE_4, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_SE_4  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
     ...
     $.ajax({
       ...
       dataType: 'jsonp',
       data: {},
       url: _apiURI_16x.SW_1, 

       beforeSend:  function( jqXHR_SW_1, settings ){
                                     ___XMLHttpRequest_SW_1 = jqXHR_SW_1
                    },
       error: function (jqXHR_SW_1, textStatus, errorThrown) {
               var _error_status = textStatus + ' : ' + errorThrown;         
               console.log('jqXHR_SW_1  : ', _error_status);
              }, 
       success: function (data) {
                   // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
                   if (typeof data === 'object') {
 ...
 $.ajax({
   ...
   dataType: 'jsonp',
   data: {},
   url: _apiURI_16x.SW_2, 

   beforeSend:  function( jqXHR_SW_2, settings ){
                                 ___XMLHttpRequest_SW_2 = jqXHR_SW_2
                },
   error: function (jqXHR_SW_2, textStatus, errorThrown) {
           var _error_status = textStatus + ' : ' + errorThrown;         
           console.log('jqXHR_SW_2  : ', _error_status);
          }, 
   success: function (data) {
               // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
               if (typeof data === 'object') {
  ...
  $.ajax({
   ...
   dataType: 'jsonp',
   data: {},
   url: _apiURI_16x.SW_3, 

   beforeSend:  function( jqXHR_SW_3, settings ){
                                 ___XMLHttpRequest_SW_3 = jqXHR_SW_3
                },
   error: function (jqXHR_SW_3, textStatus, errorThrown) {
           var _error_status = textStatus + ' : ' + errorThrown;         
           console.log('jqXHR_SW_3  : ', _error_status);
          }, 
   success: function (data) {
               // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
               if (typeof data === 'object') {
  ...
  $.ajax({
   ...
   dataType: 'jsonp',
   data: {},
   url: _apiURI_16x.SW_4, 

   beforeSend:  function( jqXHR_SW_4, settings ){
                                 ___XMLHttpRequest_SW_4 = jqXHR_SW_4
                },
   error: function (jqXHR_SW_4, textStatus, errorThrown) {
           var _error_status = textStatus + ' : ' + errorThrown;         
           console.log('jqXHR_SW_4  : ', _error_status);
          }, 
   success: function (data) {
               // jsonp, usually return object.   cors, proxy, can return both string and object, must handle difference  
               if (typeof data === 'object') {
