              ...
              history.pushState(null, '', _____newRelativePathQuery);
               ...
               // ========= setting tab ==============   
                  ...
                  function set_map_style(____strokeColor, ____strokeWeight, ____fillColor , ____circle_radius){
                                  ...
                                  map.data.setStyle({
                                  //       - -  -  -  entire   - -  -  - 
                                     // large amount of point need default point 
...
function init_user_interface_event(){
        ...
        $("#download_csv_button").on("click", function() {
          entire_geojson_object = {
            type: "FeatureCollection",
            features: _all_feature_flat_array,
          }
          json_for_csv = geojson_to_csvReadyJsonArray(entire_geojson_object)
          ...
          saveStringAsFile('entire.csv', final_csv_string)
      });
    /**/
    //  - - -  end  - - -   download csv    - - - 
    /**/
   ...
   /**/
    ...
    $("#download_geojson_button").on("click", function() {
      ...
      saveJsonAsFile('entire.geojson', entire_geojson_object)
    });
  /**/
