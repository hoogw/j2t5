...
/**/
    ...
    var background_type = 'image'  // image only
                            ...
                            //  ======  ===== =======  group by  ======  ===== =======  
                                    ...
                                    /**/
                                            ...
                                            if (filterValueList_by_keyword){
                                                  // filtered value list
                                                  /**/
                                                  // both esri, socrata, SQL are case-sensitive, must use LOWER ( field name ) = keyword.toLowerCase() 
                                                  ...
                                                  _url_distinctFieldValue_groupby =  background_mapserver_url + '/'+  layer_id + '/query?'+  'where=' + encoded_where_clause_for_filterValueList + '&outStatistics=' + encoded_outStatistics + '&groupByFieldsForStatistics=' + _fieldName  +'&f=pjson'
                                                  ...
                                                  // all value list
                                                  _url_distinctFieldValue_groupby =  background_mapserver_url + '/'+  layer_id + '/query?outStatistics=' + encoded_outStatistics + '&groupByFieldsForStatistics=' + _fieldName  +'&f=pjson'
...
// ======  ===== =======    distinct  ======  ===== =======  
                              ...
                              if (filterValueList_by_keyword){
                                    ...
                                    //where_clause_for_filterValueList = _fieldName + " like '%" + filterValueList_by_keyword + "%' "
                                                          where_clause_for_filterValueList = "LOWER(" + _fieldName + ") like '%" + filterValueList_by_keyword + "%' "
                                    encoded_where_clause_for_filterValueList = encodeURIComponent(where_clause_for_filterValueList)
                                    _url_distinctFieldValue_distinct =  background_mapserver_url + '/'+  layer_id + '/query?' + 'where=' + encoded_where_clause_for_filterValueList + '&outFields=' + _fieldName + '&f=pjson&returnGeometry=false&returnCountOnly=false&returnDistinctValues=true'
                
                                  } else {

                                    // all value list
                                    _url_distinctFieldValue_distinct =  background_mapserver_url + '/'+  layer_id + '/query?outFields=' + _fieldName + '&f=pjson&returnGeometry=false&returnCountOnly=false&returnDistinctValues=true&where=1=1'
...
/**/
           ...
           /**/
              ...
              var polygonFillBy = 'yellow-forward-diagonal' //'red-diagonal-cross'
            ...
            //. . . end  . . . -- -- -- only for map image layer classified  -- -- -- 
            /**/
