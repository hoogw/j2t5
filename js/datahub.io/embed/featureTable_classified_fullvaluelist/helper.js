                    ...
                    */
                    ...
                    //  ======  ===== =======  group by  ======  ===== =======  
                                                                                                              ...
                                                                                                              */
                                                                                                                    ...
                                                                                                                    // -------------- value list multiple ajax if over max record count   --------------
                                                                                                                    ...
                                                                                                                    console.log( 'value list multiple ajax if over max record count url group by total count %%%%%%  group by  %%%%%% ',  _url_distinctFieldValue_groupby_totalCount)
                                                                                                                    // ------ end -------- value list multiple ajax if over max record count   --------------  
                      ...
                      //  ======  =====  end =======    group by  ======  ===== ======= 
                                                                                                          ...
                                                                                                          // ======  ===== =======    distinct  ======  ===== =======  
                                                                                                                ...
                                                                                                                console.log( 'value list multiple ajax if over max record count url <<<<<<< distinct >>>>>>> FieldValue ........  ', _url_distinctFieldValue_distinct_totalCount)
                                                                                                                // ------ end -------- value list multiple ajax if over max record count   -------------- 
                                                        ...
                                                        // url group-by
                                                                                    ...
                                                                                    /**/
                                                                                     ...
                                                                                     if (_totalCount_of_current_valueList <= maxRecordCount){
                                                                                          // normal 1 ajax 1 page
                                                                                          raw_distinctFieldValue = await ajax_try_jsonp_cors_proxy_return_json_object(_url_distinctFieldValue_groupby)
                                                                                     } else {

                                                                                          // multiple page, ajax
                                                                                          var number_of_ajax = Math.ceil(_totalCount_of_current_valueList / maxRecordCount)
                                                                                          console.log(' total Count of current value List > max Record Count, need how many ajax:', number_of_ajax, '   total:',  _totalCount_of_current_valueList,  '   max record count:', maxRecordCount)
                                                                                          
                                                                                          var temp_raw_distinctFieldValue
                                                                                          var maxRecCt_url_distinctFieldValue_groupby = _url_distinctFieldValue_groupby + '&resultRecordCount=' + maxRecordCount
                                                                                          var temp_url_distinctFieldValue_groupby
                                                                                          var features_array = []


                                                                                          for (let a = 0; a < number_of_ajax; a++) {
                                                                                            temp_url_distinctFieldValue_groupby = maxRecCt_url_distinctFieldValue_groupby + '&resultOffset=' +  a * maxRecordCount;
                                                                                            temp_raw_distinctFieldValue = await ajax_try_jsonp_cors_proxy_return_json_object(temp_url_distinctFieldValue_groupby)

                                                                                            if (temp_raw_distinctFieldValue.error) {
                                                                                              break;
                                                                                            } else {
                                                                                              Array.prototype.push.apply(features_array, temp_raw_distinctFieldValue.features);
                                                                                            }//if 

                                                                                          }//for

                                                                                          if (temp_raw_distinctFieldValue.error) {
                                                                                            raw_distinctFieldValue = temp_raw_distinctFieldValue
                                                                                          } else {
                                                                                            raw_distinctFieldValue['features'] = features_array
                                                                                          }


                                                                                     }// if // multiple page, ajax
                                                                                          ...
                                                                                          /**/
                                                                                            ...
                                                                                            if (_totalCount_of_current_valueList <= maxRecordCount){
                                                                                              ...
                                                                                              raw_distinctFieldValue = await ajax_try_jsonp_cors_proxy_return_json_object(_url_distinctFieldValue_distinct)
                                                                                                        ...
                                                                                                        // multiple page, ajax
                                                                                                        var distinct_number_of_ajax = Math.ceil(_totalCount_of_current_valueList / maxRecordCount)
                                                                                                        console.log('  distinct only,,,, total Count of current value List > max Record Count, need how many ajax:', number_of_ajax, '   total:',  _totalCount_of_current_valueList,  '   max record count:', maxRecordCount)
                                                                                                        

                                                                                                        var distinct_temp_raw_distinctFieldValue
                                                                                                        var maxRecCt_url_distinctFieldValue_distinct = _url_distinctFieldValue_distinct + '&resultRecordCount=' + maxRecordCount
                                                                                                        var temp_url_distinctFieldValue_distinct
                                                                                                        var distinct_features_array = []
              
              
                                                                                                        for (let a = 0; a < distinct_number_of_ajax; a++) {
                                                                                                          temp_url_distinctFieldValue_distinct = maxRecCt_url_distinctFieldValue_distinct + '&resultOffset=' +  a * maxRecordCount;
                                                                                                          distinct_temp_raw_distinctFieldValue = await ajax_try_jsonp_cors_proxy_return_json_object(temp_url_distinctFieldValue_distinct)
              
                                                                                                          if (distinct_temp_raw_distinctFieldValue.error) {
                                                                                                            break;
                                                                                                          } else {
                                                                                                            Array.prototype.push.apply(features_array, distinct_temp_raw_distinctFieldValue.features);
                                                                                                          }//if 
              
                                                                                                        }//for
              
                                                                                                        if (distinct_temp_raw_distinctFieldValue.error) {
                                                                                                          raw_distinctFieldValue = distinct_temp_raw_distinctFieldValue
                                                                                                        } else {
                                                                                                          raw_distinctFieldValue['features'] = features_array
                                                                                                        }
