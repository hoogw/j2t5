                        ...
                        // point
                         ...
                         for (let m = 0; m < marker_array.length; m++) {
                            ...
                            if (delete_objectid_array.includes(marker_array[m].object_id)){
                                  ...
                                  //console.log('feature for each, delete this obj id - feature ', marker_array[m].object_id )

                                  _delete_Index = m
                                  marker_array[_delete_Index].map = null
                                  marker_array.splice(_delete_Index, 1);
