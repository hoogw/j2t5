...
var limit_by_bound_or_location = 'location'




// this is only difference between yelp1 and yelp2
// function poi_viewer(___properties){




// in use  limit,  by function reduce feature count
// url? render=500   (default) move to layout get it from router
...
//var arcgis_rest_api_host = 'http://maps.lacity.org/arcgis/rest/services/Mapping/NavigateLA/MapServer/';
//                            http://maps.lacity.org/lahub/rest/services
//var google_map_api_key = 'xxxxxxxxxxx';
    ...
    var geojson_template = {
     ...
     async function init_poi(){
            ...
            .on('changed.jstree', function (e, data) {
                ...
                if (!(data.action == 'deselect_all')){
                      ...
                      if (selected_node_type){
                          ...
                          if ((_selected_alias[0].includes('FeatureServer')) || ( _selected_alias[0].includes('MapServer'))){ 
      ...
      async function render_folder(_selected_folder_tree_id){
        ...
        // category or term not same time, before search category, clear search bar term
        clear_search_poi_result()
        ...
        for (let i = 0; i < ____poi_array.length; i++) {
          ...
          ____feature = {
            ...
            "properties": {
              ...
              "poi_alias": poi_element.alias,
              "poi_display_phone": poi_element.display_phone,
              "poi_url": poi_element.url,
              "poi_image_url": poi_element.image_url,
              "poi_phone": poi_element.phone,
              "poi_is_closed": poi_element.is_closed,
              "poi_review_count": poi_element.review_count,
              "poi_location": poi_element.location.display_address,
              "poi_categories": poi_element.categories,
            }//properties
          }//feature
        ...
        map.data.setStyle((feature) => {
          ...
          if (feature.getProperty("poi_id")) {
                ...
                //  only for POI style
                  ...
                  /**/
                  // -- -- --  google labeling -- -- --
                  var _google_label_text = feature.getProperty("poi_name")
                  ...
                  return /** @type {!google.maps.Data.StyleOptions} */ {
                    ...
                    icon        : {
                      ...
                      // -- -- --  google labeling -- -- --
                      /*
                        label position ,  labelOrigin
                        https://stackoverflow.com/questions/34251143/how-to-show-label-on-custom-icon-image-in-google-map-api

                        point radius change, so x,y should change accordingly.       
                      */
                      labelOrigin: new google.maps.Point(0, 0),  // point object x,y https://developers.google.com/maps/documentation/javascript/reference/coordinates#Point
                    },
                     //   -- -- --  end  -- -- --  google labeling -- -- -- 
                     /**/
                    ...
                    // -- -- --  google labeling -- -- --
                    // label:  property.contact_name,    // string or 
                    label:  { 
                      // MarkerLabel interface,  https://developers.google.com/maps/documentation/javascript/reference/marker#MarkerLabel
                        text: _google_label_text ,


                        className: 'black_label',   // css class  https://developers.google.com/maps/documentation/javascript/reference/marker#MarkerLabel.className
                        color: 'white', 

                        //className: 'white_label',
                        //color: 'black', 

                        fontFamily: 'serif',   // font family  https://developer.mozilla.org/en-US/docs/Web/CSS/font-family
                        fontSize: '18px',      // font size  https://developer.mozilla.org/en-US/docs/Web/CSS/font-size
                        fontWeight: 100,      // 900, bold, normal,   https://developer.mozilla.org/en-US/docs/Web/CSS/font-weight
      ...
      function poi_viewer(___properties){
        ...
        // large size
        var poi_img_large = '<img src="' + ___properties.poi_image_url + '" alt="poi image"  style="max-width:1200px;">'
        // medium size
        var poi_img_medium = '<img src="' + ___properties.poi_image_url + '" alt="poi image" style="max-width:666px;">'
        // small size
        var poi_img_small = '<img src="' + ___properties.poi_image_url + '" alt="poi image" style="max-width:300px;">'
       


        var poi_link_html = '<a target="_blank" href="' + ___properties.poi_url + '">' + ___properties.poi_url + '</a>'
        var poi_iframe_html = '<iframe src="' + ___properties.poi_url + '" style="height:675px; width:1200px;">' + ___properties.poi_url + '</iframe>'
        ...
        */
        ...
        poi_other_html    +=      '<span style="font-size:39.1px; font-weight:600;">' + ___properties.poi_name + '</span>' + '&nbsp;&nbsp;'
        poi_other_html    +=      '<sup> Reviews <span style="font-size:13.4px;  font-weight:600;">( ' + ___properties.poi_review_count + ' )</span></sup>' + '&nbsp;&nbsp;'
        poi_other_html    += '</div>'

       
        poi_other_html    += '<div>'
        poi_other_html    +=      '<span style="font-size:30.3px;">' + ___properties.poi_location + '</span>' + '&nbsp;&nbsp;'
        poi_other_html    += '</div>'
        ...
        // open close
        if (___properties.poi_is_closed){
        ...
        poi_other_html    +=      '<span style="font-size:39.9px; font-weight:800;">' + ___properties.poi_display_phone + '</span>' + '&nbsp;&nbsp;'


        // categories
        var categories_array = ___properties.poi_categories
        ...
        poi_other_html    += '<div>'
        poi_other_html    += 'HomePage:' + '&nbsp;&nbsp;' +  poi_link_html 
        poi_other_html    += '</div>'
