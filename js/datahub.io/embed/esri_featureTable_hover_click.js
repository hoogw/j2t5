...
//  feature table selection not enabled version, featureTable.filterBySelectionEnabled  should be all comment out
...
require([
  ...
  "esri/core/reactiveUtils",
   ...
   (async () => {
              ...
              var filterType = 'geometry'  // 'selection'  'autoSwitch'
                    ...
                    async function createFeatureTable(){
                      ...
                      // Create the feature table
                        featureTable = new FeatureTable({
                          ...
                          multipleSelectionEnabled : false, // not working here, must set after feature table created later
                        ...
                        /**/
                          ...
                          //   --   --    --   if user uncheck or check feature table row, highlight id changed,  should responding in map  --   --    --               
                                  ...
                                  /*  --   --  not use, use below section instead   --   -- 
                                      ...
                                      reactiveUtils.watch(
                                        ...
                                        (highlightIdsCount) => {
                                          ...
                                          // are reflected.
                                          console.log('watching feature table, high light Ids Count : ', highlightIdsCount )
                                          ...
                                          featureTable.viewModel.activeFilters.forEach((filter) => {
                                              ...
                                              console.log('watching feature table, filter type : ', filter.type )

                                              if (filter.type === "selection") {
                                                
                                              selectionIdCount = filter.objectIds.length; // the filtered selection's id count

                                              console.log('watching feature table, . . . selection  . . . Ids Count  . . . : ', highlightIdsCount )
                                        ...
                                        }// high light Ids Count
                                      ); // r e a c t i v e U t i l s . w a t c h
                                  
                            --   -- end  --   --  not use, use below section instead   --   --  */    
                            ...
                            // - - -  in use   - - -   
                                      ...
                                      featureTable.highlightIds.on("change", async (event) => {
                                        ...
                                        // ESRI unfixed bug v4.31, set false for single selection does not honored
                                        //  - -  this is temp fix this bug  - - 
                                        console.log('feature table multiple Selection Enabled :', featureTable.multipleSelectionEnabled)
                                        if (featureTable.multipleSelectionEnabled == false){
                                                                          // enforce single selection
                                                                          features.splice(0, 1)  //.splice(start, deleteCount)
                  ...
                  */
                        ...
                        if (click_or_hover == 'hover'){
                                      ...
                                      if (newObjectId == undefined) {
                                                ...
                                                // -------------- esri feature table --------------
                                                /**/
                                                    // every time mouse move, always empty previous everything
                                                    empty_info_outline_featureTable()
                                                /**/
                                                //  -------------- end  -------------- esri feature table --------------
                                                /**/
