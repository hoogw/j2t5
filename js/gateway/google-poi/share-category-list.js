      ...
      async function init_category_list(){
        ...
        for (var key in poi_categories_object) {
          ...
          jstree_root_folder(folder_structure_flatjson)
                ...
                _html_for_f_json += "</br>"
                _html_for_f_json += '<h5 style="display:inline;"  ><b>  <a target="_blank" id="root_url_link" href="https://transparentgov.net/data/live_data/google_poi_category_list.json">'  
                _html_for_f_json += "f=json" + '</a></b></h5>'
                _html_for_f_json += '<br> <h6 style="display:inline;"  ><sup><a target="_blank" id="root_url_link2" href="https://transparentgov.net/data/live_data/google_poi_category_list.json">https://transparentgov.net/data/live_data/google_poi_category_list.json</a></sup></h6>'
