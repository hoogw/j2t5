        ...
        for (let i = 0; i < point_array.length; i++) {
          ...
          point_marker.addEventListener("mouseover", ({ event, latLng }) => {
            ...
            point_marker.content = highlight_pin.element
                           ...
                           // .............. street view for poi - new marker only -  .............. 

                                      console.log(' poi point marker ', point_marker.feature.geometry)
                                      console.log(' poi point marker lat lng ', point_marker.feature.geometry.coordinates[1], point_marker.feature.geometry.coordinates[0])

                                      var poi_lat = Number(point_marker.feature.geometry.coordinates[1]);
                                      var poi_lng = Number(point_marker.feature.geometry.coordinates[0]);
