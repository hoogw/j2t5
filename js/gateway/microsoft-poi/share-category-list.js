      ...
      async function init_category_list(){
        ...
        for (let c = 0; c < poi_categories_array.length; c++) {
          ...
          jstree_root_folder(folder_structure_flatjson)
                ...
                _html_for_f_json += "</br>"
                _html_for_f_json += '<a target="_blank" id="root_url_link2" href="https://transparentgov.net/data/live_data/microsoft_poi_category_list.json" style="font-size:xx-small; font-weight: lighter;">' 
                _html_for_f_json += 'https://transparentgov.net/data/live_data/microsoft_poi_category_list.json'
                _html_for_f_json += '</a>'
