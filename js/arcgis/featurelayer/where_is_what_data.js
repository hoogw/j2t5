...
// where-is-what-data is from click-feature, add zoom to clicked feature function
  ...
  "esri/core/reactiveUtils",
   ...
   /**/
            ...
            /**/
              ...
              /**/
              //  -----  speicial edition only for where is what ----- ui ----- outside of map  ----- only for feature layer   ----- 
              /**/
...
*/
    ...
    //  - - - end - - - when map stop moving, update total count of feature show on map  - - -
       ...
       // only for 25, 25 where is what : non-embed,non-vertical,  single layer,  click only ( no hover)  
                   ...
                   if (hitResult[0]){
                                    ...
                                    //  .. - .. - ... zoom 2 feature   ... - .. - .. 
                                              ...
                                              if (zoom2feature_yesNo == 'donot_zoom2feature'){
                                                ...
                                                // polygon, line works fine, but point, would not zoom to point (closer), is because for point,geometry,extent is null. However polygon's geometry's extent have value. 
                                                console.log('(point, extent is null) (polygon or line, extent has somevalue) test 1st geometry, type, and extent  :   ', graphic.geometry.type, graphic.geometry.extent  )
              
                                                    //view.goTo(graphic).then(function(goto_results){
                                                    view.goTo(graphic.geometry).then(function(goto_results){
