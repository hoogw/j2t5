                  ...
                  /**/ 
                     ...
                     if (groundoverlay) {
                      ...
                      groundoverlay.setMap(map);
				                          ...
				                          /**/
                                  // - - - - click map as starting point  - - - - 
                                  /**/
                                  add_ground_overlay_listener_click()
                                  /**/
                                  //  - - - -  end  - - - -  click map as starting point   - - - - 
                                  /**/
                    ...
                    // click listener
                      map.data.addListener('click', function(event) {
                        ...
                        /**/
                              ...
                              // always remove previous start point
                              if (route_start_marker){route_start_marker.setMap(null)};
                              if (route_end_marker){route_end_marker.setMap(null)};

                              
                                $("#google-route-from").val(JSON.stringify(click_lat_lng_point))
                                update_url_parameter("from", JSON.stringify(click_lat_lng_point))

                                route_start_marker =  new google.maps.marker.AdvancedMarkerElement({
                                  position: click_lat_lng_point,
                                  map,
                                  title: "start from point",
                                });
