...
require([
  ...
  "esri/core/reactiveUtils",
        ...
        /**/
                  ...
                  var attachment_image_size = 'large'  // default 
        /**/
        //  -------------- end  -------------- attachment  --------------
        /**/
                ...
                if (response.results.length) {
                   ...
                   if (hitResult[0]){
                                                  ...
                                                  for (let _index = 0; _index < hitResult.length; _index++) {
                                                      ...
                                                      var html_for_attachment = ''

                                                      var _feature_id = ___properties[backgroundFeatureLayer.objectIdField];

                                                      var attachmentQuery = {
                                                        objectIds: _feature_id,
                                                        //definitionExpression: "OBJECTID < 735",
                                                        // load all type of attachment, comment out this line
                  //attachmentTypes: ["image/jpeg"] or ["image/png"] or ....
                                                      }

                                                      var attachments
                                                      try {
                                                            attachments = await backgroundFeatureLayer.queryAttachments(attachmentQuery)

                                                            console.log(' attachments ', attachments) 
                                                            // only get first key and value      
                                                            var _attachements_featureID =  Object.keys(attachments)[0];
                                                            var _attachements_array =  Object.values(attachments)[0];
                                                            var _image_url

                                                            for (var a = 0; a < _attachements_array.length; a++) { 


                                                              // w means resized image width size, can not large than original size,  maintains the aspect ratio and is only applied to attachment images
                                                              _image_url = _attachements_array[a]['url'] 
                                                              
                                                              switch (attachment_image_size) {
                                                                case 'small':
                                                                  _image_url += '?w=' + attachment_image_width_small 
                                                                  break;
                                                                case 'medium':
                                                                  _image_url += '?w=' + attachment_image_width_medium
                                                                  break;
                                                                case 'large':
                                                                  _image_url += '?w=' + attachment_image_width_large 
                                                                  break;
                                                                case 'original':
                                                                    // original size, do not add w=
                                                                    break;
                                                                default:
                                                                  console.log(`Sorry, we are out of ${attachment_image_size}.`);
                                                              }
                                                              ...
                                                              html_for_attachment += '&nbsp;&nbsp;&nbsp;'
                                                              html_for_attachment += '<a target="_blank" href="' + _image_url + '">'
                                                              
                                                              html_for_attachment +=   '<img src="' + _image_url + '" alt="' +  a + ' [' + _attachements_array[a]['name'] + '">'
                                                              html_for_attachment += '</a>'
                                                            }// for
                                                          } catch(error){
                                                      ...
                                                      if (_index == 0){
                                                                        ...
                                                                        multiple_layer_properties_html +=            html_for_attachment
...
/**/                      
      ...
      function init_background_layer(){
        ...
        // .... ... ...  background layer url .... ... ... 
          ...
          function init_user_interface_event(){
                ...
                // -------------- attachment  --------------
                /**/
                if (param_attachment_image_size){
                  attachment_image_size = param_attachment_image_size
                }
                // first time set radio
                $("input[type=radio][name=attachment-image-size-radio][value=" + attachment_image_size + "]").prop('checked', true);
                // radio change event
                $("input[type='radio'][name='attachment-image-size-radio']").change(function(){
                  attachment_image_size = $("input[type='radio'][name='attachment-image-size-radio']:checked").val();
                  console.log(" attachment_image_size : --  ", attachment_image_size);
                  update_url_parameter('attachmentimagesize', attachment_image_size);
                });
    ...
    /**/
              ...
              async function show_info_outline_Tab(___properties){
                ...
                // rest api, not use, https://developers.arcgis.com/rest/services-reference/enterprise/attachment-infos-feature-service/
                //var _attachment_info_url = background_layer_url + '/' +  _feature_id + '/attachments'

                var attachmentQuery = {
                  objectIds: _feature_id,
                  //definitionExpression: "OBJECTID < 735",
                  // load all type of attachment, comment out this line
                  //attachmentTypes: ["image/jpeg"] or ["image/png"] or .... or ["image/png"] or .... 
                }
                ...
                _html_everything +=           html_for_attachment
