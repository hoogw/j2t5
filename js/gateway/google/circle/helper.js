...
/**/
                  ...
                  function add_mapdata_listener(){
                    ...
                    // click listener
                      map.data.addListener('click', function(click_event) {
                        console.log(' geojson data layer get clicked event ', click_event)
                        console.log(' geojson data layer get clicked event lat lng ', click_event.latLng.lat(), click_event.latLng.lng())
                        ...
                        console.log(' geojson data layer get clicked event lat lng ', click_lng, click_lat)
          ...
          // ----------  add map listener idle ---------- 
                              ...
                              function add_map_listener_idle(){   
                                ...
                                listener_idle =  map.addListener('idle', function() {   
                                  ...
                                  //  --- google manual drawing circle   --- 
                                  /**/
                                  get_circle_radius_in_map_bound()
                                  manually_adjust_max_circle_radius()
              ...
              /**/
                  ...
                  // never fire this event, because ground-overlay-image layer blocked map 
                  // unless you don't add ground-overlay-image layer, this event will be fired.
...
$("#max-return-count").html(maxRecordCount)
  ...
  $("#start_over_button").on("click", function() {
      ...
      ____unique_objectId_array = []
      selected_feature_array = []
      total_selected_feature_count = 0
      $("#total_count").html(total_selected_feature_count)

       // select object id array is empty, paint again will just paint all blue back to yellow
...
/**/
        ...
        $("#download_csv_button").on("click", function() {
          var _geojson_intersect_by_all_shape = {
            "type": "FeatureCollection",
            "features": selected_feature_array,
          };
          json_for_csv = geojson_to_csvReadyJsonArray(_geojson_intersect_by_all_shape)
          ...
          saveStringAsFile('selectedFeatureOnMap.csv', final_csv_string)
      });
    /**/
    //  - - -  end  - - -   download csv    - - - 
    /**/
        ...
        $("#download_selectedFeatureOnMap_button").on("click", function() {
          ...
          saveJsonAsFile('selectedFeatureOnMap.geojson', _geojson_intersect_by_all_shape)
        });
