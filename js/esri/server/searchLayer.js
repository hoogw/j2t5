                        ...
                        html += '<div>';
                          ...
                          if (_results.length > 0) {
                                                        ...
                                                        if ((_____type.includes("table")) || (_____type.includes("Table"))){       
                                                              ...
                                                              // ============= for feature tables only =====================
                                                               /**/
                                                                    ...
                                                                    // text
                                                                    html += '<span class="context"><big><b>' + '.&nbsp;&nbsp;&nbsp;' + _name_stripedHtml   + '</b></big></span>' + '&nbsp;&nbsp;<small><sup>' +  _____type  +  '</sup></small>'

                                                                    // only difference server2/searchLayer,  has showdetails button
                                                                    if ($('#detail_container').length){
                                                                        
                                                                        html += '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                                                                        //html += '<button id="show_details_btn" class="click_change_style" onclick="show_details(\''   +  _____table_url + '\',' +  _____layer_id +  ',' +   '\'' +  _name_stripedHtml +  '\','  +  '\'table\''  +')">show details</button>'
                                                                        var value_param = {
                                                                          url:     _____table_url,
                                                                          layerId: _____layer_id, 
                                                                        ...
                                                                        html += '<sup> &#9758; show &#8680; <b><small>' + _____type + '</small></b></sup>'
                                                                        html += '&nbsp;&nbsp;'
                                                                    }
                                                            ...
                                                            /**/
                                                            // order is matter,  table, raster must before MapServer 
                                                            if (_____type.includes("Raster") || _____type.includes("raster")){  
                                                              // ********** raster layers only **********
                                        /**/
                                  ...
                                  /**/
                                                                                              ...
                                                                                              if ($('#detail_container').length){
                                                                                                    html += '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                                                                                                    //html += '<button id="show_details_btn" class="click_change_style" onclick="show_details(\''   +  _____layer_url + '\',' +  _____layer_id +  ',' +   '\'' +  _name_stripedHtml +  '\','  +  '\'raster_layer\''  +')">show details</button>'
                                                                    ...
                                                                    if (_____type == "Raster Catalog Layer") {
                                                                        /*
                                                                          only for  "raster catalog layer" "Raster Catalog Layer" , is a layer with tile grid line only, no tile, 
                                                                          just treat it as regular 'feature layer' ,  show raster tile boundary as feature layer. this only apply for "Raster Catalog Layer", for normal "raster layer", use link above
                                                                        ...
                                                                        */
                                                                        // nothing to do here, show details will handle it
                                                                    }
                                                              // **********  end  **********  raster layers only **********
                                                                ...
                                                                /*
                                                                  ...
                                                                  */
                                                                                  ...
                                                                                  // text
                                                                                  html += '<span class="context"><big><b>' + '.&nbsp;&nbsp;&nbsp;' + _name_stripedHtml   + '</b></big></span>' + '&nbsp;&nbsp;<small><sup>'  + 'SceneServer' +  '</sup></small>'
                                                                                 

                                                                                  // only difference server2/searchLayer,  has showdetails button
                                                                                  if ($('#detail_container').length){
                                                                                          html += '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                                                                                          //html += '<button id="show_details_btn" class="click_change_style" onclick="show_details(\''   +  _____layer_url + '\',' +  _____layer_id +  ',' +   '\'' +  _name_stripedHtml +  '\','  +  '\'scene_server\''  +')">show details</button>'
                                                                                          ...
                                                                                          console.log('value param string', value_param_string)
                                                                                          html += "<input type='radio' name='show_details_radio' value='" + value_param_string  +"'/>"
                                                                                          html += '<sup> &#9758; show &#8680; <b><small>' + 'SceneServer' + '</small></b></sup>'
                                                                                          html += '&nbsp;&nbsp;'
                                                                                  }
                                                                            ...
                                                                            */
                                                                            if   (_____type.includes("Feature")){ 
                                                                                                      ...
                                                                                                      if ($('#detail_container').length){
                                                                                                          html += '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                                                                                                          //html += '<button id="show_details_btn" class="click_change_style" onclick="show_details(\''   +  _____layer_url + '\',' +  _____layer_id +  ',' +   '\'' +  _name_stripedHtml +  '\','  +  '\'feature_layer\''  +')">show details</button>'
...
/**/
    ...
    /**/
        ...
        function reset_everything(){
          ...
          console.log(' reset naming tree to original, clean detail panel . .. .. . ')
          reset_naming_tree()
          turn_off_detail_panel()
        }
