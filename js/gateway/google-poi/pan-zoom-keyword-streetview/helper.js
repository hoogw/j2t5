...
/**/
                      ...
                      // mouse over listener
                        map.data.addListener('mouseover', function (event) {   
                         ...
                         /*
                            street view pegman on enlarged poi point, cause shaking, flashing, so do not highlight enlarge poi point, 
                            pegman sit on it already has effect of highlight.
                         ...
                         // .............. end   ..............  street view for poi  .............. 
                                      ...
                                      console.log(' poi hovered event ', event)
                                      console.log(' poi hovered event lat lng ', event.latLng.lat(), event.latLng.lng())

                                      var poi_lat = Number(event.latLng.lat());
                                      var poi_lng = Number(event.latLng.lng());
                                      var poi_lat_lng_point = { lng : poi_lng, lat : poi_lat }
                                      console.log(' **** poi hovered *** >>> lng, lat ', poi_lng, poi_lat)


                                      // fix bug, each hover event fire 4 times, I only need 1 lat-lng for street view.
                                      if ((last_poi_lat == poi_lat) && (last_poi_lng == poi_lng)){
                                        // skip, nothing to do, 
                                      } else {
                                        turn_on_street_view(poi_lat, poi_lng, 100)
                                        last_poi_lat = poi_lat
                                        last_poi_lng = poi_lng
                                      }
                        ...
                        map.data.addListener('mouseout', function (event) {
                          ...
                          /*
                           ...
                           street view pegman cause mouse out, not show properties, 
                           so I want keep properties here 
