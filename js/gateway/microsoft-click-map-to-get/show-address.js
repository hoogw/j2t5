            ...
            map.events.add('moveend', function(){
                ...
                map.events.add('click', function(event){
                    ...
                    console.log('you click map, event ', event)
                        ...
                        var click_lat = Number(event.position[1]);
                        var click_lng = Number(event.position[0]);
                       
                        console.log(' **** clicked microsoft  *** >>> lng, lat ', click_lng, click_lat)

                        /**/
                        //  --- microsoft geocode    --- 
                        /**/
                              
                              microsoft_geocode_api_reverseGeocode(click_lng, click_lat, radiusMeterForSinglePOI)
