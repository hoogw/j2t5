...
/**/
        ...
        async function nearby_poi_4circle(_radiusMeter, _centerLng, _centerLat) {
        ...
        /**/
            ...
            // search poi category api 
            // URL REST parameter is here https://learn.microsoft.com/en-us/rest/api/maps/search/get-search-poi-category?view=rest-maps-1.0&tabs=HTTP
            ...
            console.log('search nearby NW_results ', NW_results)
            ...
            console.log('search nearby NE_results ', NE_results)
            ...
            console.log('search nearby SE_results ', SE_results)
            ...
            console.log('search nearby SW_results ', SW_results)

            // add 4 xx_poi_geojson into single 
            geojsonTemplateFeatures_array = [...NW_results.results, ...NE_results.results, ...SE_results.results, ...SW_results.results]
...
function moveend_handler(){
   ...
   setLimit_onNearbyCircleRadius()
    ...
    clear_all_circle()
     ...
     drawing_4circle(_center_radius_in_meter, _center_long, _center_lat)
...
function add_map_event(){
    ...
    //map.events.add('idle', moveend_handler);
    // in use
    ...
    if (circle_datasource){
        ...
        function  drawing_4circle(_radiusMeter, _centerLng, _centerLat){
            ...
            if (circle_datasource){
                        ...
                        circle_datasource.add(new atlas.data.Feature(quater_NW_point, {
                            subType: "Circle",
                            radius: _4circle_radius
                        }));

                        circle_datasource.add(new atlas.data.Feature(quater_NE_point, {
                            subType: "Circle",
                            radius: _4circle_radius
                        }));

                        circle_datasource.add(new atlas.data.Feature(quater_SW_point, {
                            subType: "Circle",
                            radius: _4circle_radius
                        }));

                        circle_datasource.add(new atlas.data.Feature(quater_SE_point, {
                            subType: "Circle",
                            radius: _4circle_radius
                        }));
            }//if
