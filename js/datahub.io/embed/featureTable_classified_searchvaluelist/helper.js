                                                        ...
                                                        if (____fieldType_lowerCase.includes('string')){ 
                                                          ...
                                                          // token
                                                                                                                            ...
                                                                                                                            if (arcgis_online_token){
                                                                                                                              _url_distinctFieldValue_groupby += '&token=' + arcgis_online_token
                                                                                                                            }
                              ...
                              /**/
                                            ...
                                            if (filterValueList_by_keyword){
                                                  ...
                                                  _url_distinctFieldValue_distinct =  _url + '/'+  _layer_id + '/query?outFields=' + _fieldName + '&f=pjson&returnGeometry=false&returnCountOnly=false&returnDistinctValues=true&where=1=1'
                                                                                                                        ...
                                                                                                                        //console.log('arcgis_online_token = = =',  arcgis_online_token)
                                                                                                                        if (arcgis_online_token){
                                                                                                                          _url_distinctFieldValue_distinct += '&token=' + arcgis_online_token
                                                                                                                        }
                    ...
                    if (real_distinct_fieldvalue_array) {
                      if ( real_distinct_fieldvalue_array.length > 0 ) {
                            ...
                            for (var r = 0; r < real_distinct_fieldvalue_array.length; r++) { 
                              ...
                              /**/
                                      // - - - filter value list  - - - mark.js - - - 
                                      /**/
                                          //value_html +=    _node_display_text
                                          value_html +=  '<span class="context">' + _node_display_text + '</span>'
                                      /**/
                                      // ... end ...  - - - filter value list  - - - mark.js - - -
                                      /**/  
                            ...
                            // - - - filter value list  - - - mark.js - - - 
                            /**/
                                  console.log(' mark.js highlight filter ValueList by keyword', filterValueList_by_keyword)
                                  if (filterValueList_by_keyword){
                                    $("span.context").mark(filterValueList_by_keyword);
                                  }
                            /**/
                            // ... end ...  - - - filter value list  - - - mark.js - - -
                            /**/
                        ...
                        //  re-create instance of url params
                         _rightnow_url_params = new URLSearchParams(window.location.search);
                            ...
                            console.log('selected_fieldvalue_id',  selected_fieldvalueLevel_id)
                                                    ...
                                                    // - - - filter value list  - - - 
                                                    /**/
                                                    filterValueList_by_keyword = _rightnow_url_params.get('filtervaluelist');
