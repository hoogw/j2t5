      ...
      async function suggest(){
            ...
            if (keywords){
              ...
              //   -  -  - normal suggest   -  -  -
                ...
                // fake street address (no color) 
                await basic_default_suggest_this_category_paint_as_this_color("Street Address", "no-color")
              //    -  -  - end  -  -  - normal suggest   -  -  -
              ...
              /**/
                ...
                if ((Number.isInteger(Number(keywords))) && (keywords.length > 1)){
                  ...
                  await advanced_number_search_this_category_paint_as_this_color("Street Address", "no-color")
                }//if
