     ...
     async function init_feature_layer_view(){
        ...
        arcgisMap.addEventListener("arcgisViewClick", async (event) => {
          ...
          var user_clicked_point_lat = event.detail.mapPoint.latitude
          var user_clicked_point_lng = event.detail.mapPoint.longitude
          console.log("user clicked point ", user_clicked_point_lat,  user_clicked_point_lng )


          var lat_comma_lng = user_clicked_point_lat  + ',' + user_clicked_point_lng
          ...
          //  --- esri geocode    --- 
          /**/
                esri_geocode_api_reverseGeocode_compact_for_compare(user_clicked_point_lng, user_clicked_point_lat)
          ...
          /**/
                        ...
                        //  --- microsoft geocode    --- 
                        /**/ 
                              microsoft_geocode_api_reverseGeocode_compact_for_compare(user_clicked_point_lng, user_clicked_point_lat, radiusMeterForSinglePOI)
                    ...
                    //  --- here map    --- 
                    /**/
                          here_map_geocode_api_reverseGeocode_compact_for_compare(lat_comma_lng)
                  ...
                  /**/
                         ...
                         google_place_api_reverseGeocode_compact_for_compare(lat_comma_lng)
                  /**/
