  ...
  function json2html(json, _json_id, options) {
    ...
    if (typeof json === 'string') {
      ...
      if (isUrl(json))
       ...
       // http://maps.lacity.org/arcgis/rest/services/Mapping/NavigateLA/MapServer/5?layer=a%20b
           
        html += '<a target="_blank" href="' + base_url + _json_id + '?layer='+ json + '" class="json-string">' + json +  ' ('+ _json_id + ')' +'</a>';
    }
