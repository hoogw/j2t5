...
// -- -- --  esri return centroid google labeling -- -- -- 
        ...
        /**/
        // -- -- --  esri return centroid google labeling -- -- -- __   __ polygon line labeling  __   __   __ 
        ...
        //  __   __   __  end  -- -- --  esri return centroid google labeling -- -- --   __   __  polygon line labeling  __   __   __ 
        /**/
...
/**/
            ...
            function add_data_maps(data) {
                                    ...
                                    // only feature server , polygon can do centroid
                                    if ((_url.includes('/FeatureServer')) && (featurelayer_geometrytype.includes('Polygon') || featurelayer_geometrytype.includes('polygon'))){
                                      // only feature server , polygon can do centroid
                                      // inject centroid x,y into feature properties
                                      for (let i = 0; i < arcgis_feature_Set.features.length; i++) {
                                        arcgis_feature_Set.features[i]['attributes']['esri_centroid_lng'] = arcgis_feature_Set.features[i]['centroid']['x']
                                        arcgis_feature_Set.features[i]['attributes']['esri_centroid_lat'] = arcgis_feature_Set.features[i]['centroid']['y']
                                      }  

                                    } else {

                                      // will set centroid after convert to geojson
                                    ...
                                    // only feature server , polygon can do centroid
                                    if ((_url.includes('/FeatureServer')) && (featurelayer_geometrytype.includes('Polygon') || featurelayer_geometrytype.includes('polygon'))){
                                      // feature server , polygon 
                                      // already set centroid 
                                    } else {

                                      // map-server(polygon,line,point), feature-server(line,point)
...
/**/
          ...
          async function init_label_as(){
            ...
            if (_feature_attributes) {
              ...
              // -- -- --  esri return centroid google labeling -- -- -- use as global var
