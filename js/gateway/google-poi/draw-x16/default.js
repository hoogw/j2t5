        ...
        /**/
            ...
            function drawing_16circle(_radiusMeter, _centerLng, _centerLat){
              ...
              for (let i = 0; i < circle_centerPoint_array.length; i++) {
                  ...
                  // 16x circle center lat lng  
                  _centerLng = circle_centerPoint_array[i].lng();
                  _centerLat = circle_centerPoint_array[i].lat();
                  console.log('drawing  16x circle center lat lng', i,  _16circle_radius, _centerLng, _centerLat)
            ...
            async function nearby_poi_x_circle(_radiusMeter, _centerLng, _centerLat){
                ...
                drawing_16circle(_radiusMeter, _centerLng, _centerLat)
