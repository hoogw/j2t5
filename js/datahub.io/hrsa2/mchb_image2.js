                                                  ...
                                                  .then(function() {
                                                                   ...
                                                                   console.log("Map Image Layer, is ready, ", backgroundMapImageLayer);
                                                                    ...
                                                                    /**/
                                                                      ...
                                                                      // must be here, after map image layer fully loaded, wait until native renderer get cloned. 
                                                                          init_quantity_color()
...
/* .... ... ... external function ... ... ... */     
      ...
      function init_user_interface_event(){
        ...
        /**/
        //   --- --- --- --- quantity color --- --- --- --- warning:build_quantity_renderer is only for mapImageLayer
        /**/
                ...
                if (___feature_layer_full_JSON.fields) {
                              ...
                              for (var i = 0; i < _fields_array.length; i++) {
                                 ...
                                 if (esri_possible_numeric_field_type_array.includes(____fieldType)){
                                            ...
                                            //  --- mchb only  ---
                                            _quantityField_html +=       '<sup><small class="fieldType">' + '&nbsp;' + ____fieldAlias + '</small></sup>'
       ...
       change_quantityField_handler(current_quantityFieldName)
              ...
              async function change_quantityField_handler(__quantity_field_name){
                ...
                console.log('change quantity Field handler', __quantity_field_name)
                 ...
                 //   --- . . . --- . . . filter by value --- . . . --- . . .
                 /**/
                      if (current_quantityFieldName){
                                          //filter by value range option 
                                          $("#currentSymbolFieldNameAlias_span").html(field_alias[current_quantityFieldName])
                                          $("#currentSymbolFieldName_span").html(current_quantityFieldName)

                                          $("span.context").mark(current_quantityFieldName); // will mark the keyword "test", requires an element with class "context" to exist
              ...
              function build_quantity_renderer(){
                ...
                // ----------- get geometry type  ----------- only for mapImageLayer ----------- 
                ...
                // ----- --- --- End --- --- --- ---   get geometry type  ----------- only for mapImageLayer -----------
                ...
                if ((current_colorScale) && (current_quantityFieldName)  && (quantity_class_range_array)){
                        ...
                        let quantity_class_breaks_renderer = new ClassBreaksRenderer({
                          ...
                          //minValue: min_value // read only , can not  set here,
                        ...
                        console.log('image class breaks renderer  ', quantity_class_breaks_renderer)
                        
                        // only for mapImageLayer
                        backgroundMapImageLayer.sublayers.items[0].renderer = quantity_class_breaks_renderer;
      ...
      /**/
            ...
            /**/ 
              ...
              if (current_quantityFieldName){
                    editor_info_outline.search(current_quantityFieldName)
              }
            /**/
            //  --- end  ---  mchb only   --- 
            /**/
                ...
                /**/
                          ...
                          function init_filter_by(){
                            ...
                            $( "#apply_value_range_btn" ).on( "click", function() {
                                        ...
                                        if (!(current_quantityFieldName)){ alert('invalid no subject field selected'); return null;}


                                        if (isNaN(more_than_float)){

                                                  sql_where =  current_quantityFieldName + ' < ' + less_than_float

                                        } else {

                                                  sql_where =  current_quantityFieldName + ' > ' + more_than_float

                                                  if (isNaN(less_than_float)){
                                                      // nothing to do
                                                  } else {
                                                    sql_where += ' AND ' + current_quantityFieldName + ' < ' + less_than_float
                                                  }
                                        }
